...
extern DRAM_ATTR int dpm_locked;
extern DRAM_ATTR int settings_milliamps;
extern DRAM_ATTR int settings_millivolts;
extern DRAM_ATTR int measured_ma;
extern DRAM_ATTR int measured_mv;
